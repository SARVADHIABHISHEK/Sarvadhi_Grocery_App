...
import 'package:sarvadhi_mart/features/location/domain/models/zone_model.dart';
...
class LocationRepository implements LocationRepositoryInterface {
  ...
  Future<String> getAddressFromGeocode(LatLng latLng) async {
    ...
    if (response.statusCode == 200 && response.body['status'] != 'OK') {
      ...
      ///Changed Here
      address =
          '5QRP+Q2J, Subhash Chandra Bose Marg, TGB, Adajan Gam, Adajan, Surat, Gujarat 395009, India';
    } else {
  ...
  Future<ZoneResponseModel> getZone(String? lat, String? lng,
    ...
    if (response.statusCode == 200) {
      ...
      return ZoneResponseModel(
          false, response.statusText, [], [], [], response.statusCode);
    }
  }

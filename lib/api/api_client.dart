...
import 'package:sarvadhi_mart/api/api_checker.dart';
import 'package:sarvadhi_mart/features/address/domain/models/address_model.dart';
import 'package:sarvadhi_mart/common/models/error_response.dart';
...
class ApiClient extends GetxService {
  ...
  Map<String, String> updateHeader(
    ...
    if (moduleID != null ||
      ...
      header.addAll({AppConstants.moduleId: '1'});
    }
    ...
    header.addAll({
      ...
      AppConstants.latitude: '21.1593403',
      AppConstants.longitude: '72.7398947',
